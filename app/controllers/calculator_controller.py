...
class CalculatorController(ControllerBase):
    ...
    def post():
        if request.form['value1'] == '' or request.form['value2'] == '':
            ...
            k = Calculator.writeHistoryToCSV(data)
            print(k)

            return render_template('result.html', data=Calculator.getHistoryFromCSV(), value1=value1, value2=value2, operation=operation, result=result)
